                    ...
                    >
                        ...
                        <div className="flex flex-col items-center">
                            <ul className="space-y-4 text-left">
                                <li className="flex items-start gap-3 text-[#1a2e35]"><Check className="w-5 h-5 text-[#8b8b4e] shrink-0 mt-0.5" /> <span>Unlimited access to home & pet care</span></li>
                                ...
                                <li className="flex items-start gap-3 text-[#1a2e35]"><Check className="w-5 h-5 text-[#8b8b4e] shrink-0 mt-0.5" /> <span>Unlimited listings</span></li>
                            </ul>
                        </div>
                    </motion.div>
